...
var Queue = function Queue(name, redisPort, redisHost, redisOptions, stalled_job_check_interval){
  if(!(this instanceof Queue)){
    return new Queue(name, redisPort, redisHost, redisOptions, stalled_job_check_interval);
  }

  if (typeof stalled_job_check_interval != 'undefined') {
    STALLED_JOB_CHECK_INTERVAL = stalled_job_check_interval;
  }
